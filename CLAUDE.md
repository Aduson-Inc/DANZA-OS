...
(`danzaboss/` — kernel, CORTEX, hooks, research, runtime; 277 tests).
...
danzaboss/                  THE BRAIN (promoted, authoritative) — Python, stdlib only, 277 tests
  ...
  tests/  run_tests.sh       277 unit tests + cold-start harness
...
- **Run the test suite:** `./danzaboss/run_tests.sh` (277 tests)
