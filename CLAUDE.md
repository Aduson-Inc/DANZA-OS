...
(`danzaboss/` — kernel, CORTEX, hooks, research, runtime, workstation; 877 tests).
...
danzaboss/                  THE BRAIN (promoted, authoritative) — Python, stdlib only, 877 tests
  ...
  tests/  run_tests.sh       877 unit tests + cold-start harness
...
- **Run the test suite:** `./danzaboss/run_tests.sh` (877 tests)
