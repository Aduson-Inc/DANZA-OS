...
(`danzaboss/` — kernel, CORTEX, hooks, research, runtime; 227 tests).
...
danzaboss/                  THE BRAIN (promoted, authoritative) — Python, stdlib only, 227 tests
  ...
  tests/  run_tests.sh       227 unit tests + cold-start harness
...
- **Run the test suite:** `./danzaboss/run_tests.sh` (227 tests)
