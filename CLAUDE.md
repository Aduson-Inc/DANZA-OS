...
(`danzaboss/` — kernel, CORTEX, hooks, research, runtime, workstation; 983 tests).
...
danzaboss/                  THE BRAIN (promoted, authoritative) — Python, stdlib only, 983 tests
  ...
  tests/  run_tests.sh       983 unit tests + cold-start harness
...
- **Run the test suite:** `./danzaboss/run_tests.sh` (983 tests)
